	...
	public class HugeRain : ModProjectile
	{
		...
		public override void Kill(int TimeLeft)
		{
			...
			for (int i = 0; i < Main.rand.Next(3, 5); i++)
			{
				...
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<Waternado>(), 40, 5f, projectile.owner);
			}
