...
namespace Trinitarian.Projectiles.Magus
{
    ...
    public class NightsisterMagicMain : ModProjectile
    {
        ...
        public override string Texture => "Trinitarian/Projectiles/Magus/NightsisterMagic";
    ...
    public class NightsisterMagic : OrbitingProjectile
    {
        ...
        {
            Texture2D texture = ModContent.GetTexture("Trinitarian/Projectiles/Magus/NightsisterMagic");
        ...
        public override void AI()
        {
            ...
            if (Proj_State == State_Moving || Proj_State == State_Spawning || Proj_State == State_Initializing)
            {
                ...
                projectile.damage = 330 * modplayer.OrbitingProjectileCount[ProjectileSlot];
            }
            base.AI();
