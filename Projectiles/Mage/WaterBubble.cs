...
namespace Trinitarian.Projectiles.Mage
{
    class WaterBubble : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, DustID.Water, 0f, 0f, 100);
                Main.dust[num].noGravity = true;
                int num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, DustID.Water, 0f, 0f, 100);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < Main.rand.Next(3, 5); i++)
            {
                ...
                Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<FireStaffProj>(), 40, 5f, projectile.owner);
            }
        }

        public Color TrailColor(float progress)
        {
            return Color.Lerp(Color.Blue, Color.Cyan, progress) * (1f - progress);
        }
