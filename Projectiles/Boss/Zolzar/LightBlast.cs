...
{
	class LightBlast : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<LightBolt>(), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
