...
{
    public class VikingBlast : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Viking Bolt");
        ...
        public override void AI()
        {
            ...
            {
                int num1110 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Smoke, projectile.velocity.X, projectile.velocity.Y, 50, default(Color), 1.2f);
            ...
            {
                int num1106 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Smoke, projectile.velocity.X, projectile.velocity.Y, 50, default(Color), 0.4f);
                switch (num1103)
                {
                    case 0:
