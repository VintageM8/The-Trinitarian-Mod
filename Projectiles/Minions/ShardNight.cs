...
{
    public class ShardNight : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Shard of the Night");
        ...
        public override void AI()
        {
            ...
            {
                player.ClearBuff(ModContent.BuffType<ShardBuff>());
            }
            if (player.HasBuff(ModContent.BuffType<ShardBuff>()))
            {
