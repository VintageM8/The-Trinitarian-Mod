...
namespace Trinitarian
{
    ...
    public static class Utilty
    {
        ...
        /// <summary>
        /// angle between in RADIANS NOT DEGREES
        /// </summary>
        ...
        public static int AngleBetweenDeg(Vector2 vector1, Vector2 vector2)
        {
            double sin = vector1.X * vector2.X - vector2.X * vector1.Y;
            double cos = vector1.X * vector2.X + vector1.Y * vector2.Y;

            return (int)MathHelper.ToDegrees((float)(Math.Atan2(sin, cos) * (180 / Math.PI)));
        }
        /* WIP
    ...
    public class Triangle
    {
        ...
        public Triangle(Vector2 a, Vector2 b, Vector2 c)
        {
            ...
            angles = new int[3]
            {
                Utilty.AngleBetweenDeg(Vertices[0],Vertices[1]), Utilty.AngleBetweenDeg(Vertices[1],Vertices[2]), Utilty.AngleBetweenDeg(Vertices[2],Vertices[0])
            };
        }
        public Triangle(Vector2[] v)
        {
            ...
            angles = new int[3]
            {
                Utilty.AngleBetweenDeg(v[0],v[1]), Utilty.AngleBetweenDeg(v[1],v[2]), Utilty.AngleBetweenDeg(v[2],v[0])
            };
        }
