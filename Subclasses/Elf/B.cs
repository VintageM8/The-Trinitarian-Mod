...
{
    public class B : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Elf Ablillity LVL 2");
            Tooltip.SetDefault("Right click and empower your arrows");
        }
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                item.shootSpeed = 10f;
                item.knockBack = 10f;
                item.shoot = ModContent.ProjectileType<ElfPower>();
