...
{
    public class ZozarBladeproj : HeldSword
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("ZozarBladeProj");
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D slash = ModContent.GetTexture("Trinitarian/Assets/Textures/trace_01");
            ...
            Texture2D texture2D16 = mod.GetTexture("Items/Weapons/Hardmode/Melee/ZozarBladeproj/Zozar_Afterimage2");
