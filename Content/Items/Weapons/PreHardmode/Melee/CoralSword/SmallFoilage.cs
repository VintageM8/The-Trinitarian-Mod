...
{
    public class SmallFoilage : ModProjectile
    {
        private NPC target;
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Small Foilage");
        }
        ...
        public override void AI()
        {
            ...
            {
                Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Firework_Green, newColor: Color.DarkSeaGreen, Scale: 2f)].noGravity = true;
            }
