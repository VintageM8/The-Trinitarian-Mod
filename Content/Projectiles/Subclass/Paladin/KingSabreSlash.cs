...
namespace Trinitarian.Content.Projectiles.Subclass.Paladin
{
    public class KingSabreSlash : HeldSword
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            spriteBatch.Draw(texture, projectile.Center - Main.screenPosition, null, Color.Silver, projectile.rotation, orig, projectile.scale, SpriteEffects.None, 0f);
            return false;
        }
    }
}