...
namespace Trinitarian.Content.Projectiles.Subclass.Wizard
{
    public class FireStaffProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num1110 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Firefly, Projectile.velocity.X, Projectile.velocity.Y, 50, default(Color), 1.5f);
