...
{
    public class ShardofNight : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Staff of the Night Shard");
            Tooltip.SetDefault("Summons a shard thing to fight for you");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemType<UlvkilSoul>(), 2);
