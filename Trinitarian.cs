...
namespace Trinitarian
{
    public class Trinitarian : Mod
    {
		...
		private UserInterface _magusResourceBarUserInterface;
		internal MagusResourceBar MagusResourceBar;
	    ...
	    public override void Load()
        {
	       ...
	       UseAbilty = RegisterHotKey("Use Abilty", "R");
			...
			MagusResourceBar = new MagusResourceBar();
				_magusResourceBarUserInterface = new UserInterface();
				_magusResourceBarUserInterface.SetState(MagusResourceBar);
		...
		public override void PostSetupContent()
		{
			var bossChecklist = ModLoader.GetMod("BossChecklist");
			 ...
			 bossChecklist?.Call(
                ...
                new List<int> { ModContent.ItemType<IceSword>(), ModContent.ItemType<NjorsStaff>(), ModContent.ItemType<IcyTundra>(), ModContent.ItemType<NjorsMinion>(), ModContent.ItemType<ElementalPurge>(), },
        ...
        {
            _magusResourceBarUserInterface?.Update(gameTime);
            MagusResourceBar?.Update(gameTime);
        }
		...
		{			
            ...
            if (resourceBarIndex != -1)
            {
                layers.Insert(resourceBarIndex, new LegacyGameInterfaceLayer(
                    "Trinitarian: Resouce Bars",
                    delegate
                    {
                        _magusResourceBarUserInterface.Draw(Main.spriteBatch, new GameTime());
