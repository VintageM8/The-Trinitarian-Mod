    ...
    public class Trinitarian : Mod
    {
		...
		public override void PostSetupContent()
		{
			...
			if (bossChecklist != null)
			{
				 ...
				 bossChecklist.Call("AddBossWithInfo", "Zolzar, Beserker Viking", 14.5f, (Func<bool>)(() => TrinitarianWorld.downedViking), "Use a [i:" + ItemType("AsgardsCalling") + "] anywhere, anytime after Moonlord");
			}
		}
